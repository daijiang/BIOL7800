...
{  if (i==4) {  
  ...
  print(paste( "this is step", i))}
```
using next returns the machine to the begining of the loop to continue without ending cycle like break
...
set the image in images folder of wd (~/Documents/GitHub/Biol7800/classwork/images)
...
in this case does the variables value fall in the range of parameters set in vector of 1st step
```{r}
