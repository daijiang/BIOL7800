...
```
save RDS is better because you can reassign variables
...
this allows you to search using regex
...
system("rm -rf demo")
```
^test is regex for begins with test
...
```
rbind stacks the dataframes
do call?
purr has map function to maps function to each element (lists) return as a dataframe stacked
