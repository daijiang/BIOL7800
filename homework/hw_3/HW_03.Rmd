...
```
(2 points) In the example data below, extract those ranking numbers with _regular expression_. The results should have the number(s) and . if it follows after the numbers immediately (i.e., `1., 12., 105., 105.3`, etc.). Remove empty strings from the final results. You should get 107 strings for your results.
```{r}
