...
lec_per_m<- SMdf_MD |>  group_by(Month) |> summarise( Month, n =n())
#remove spacing to combine like catagoricals 

#use summarize summarise(data, month count = count (month)
